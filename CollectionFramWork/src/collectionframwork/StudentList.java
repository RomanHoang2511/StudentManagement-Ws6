...
public class StudentList extends ArrayList<Student>{
    ...
    public void updateStudent(){
        if(this.isEmpty())
            System.out.println("Emty list. No update can be performed!");
        else {
    ...
    public void removeStudent(){
        if(this.isEmpty())
            System.out.println("Emty list. No remove can be performed!");
        else {
    ...
    public void printAll(){
        if(this.isEmpty())System.out.println("Emty list!");
        else{
